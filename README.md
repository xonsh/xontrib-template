...
* [`PEP 621`](https://peps.python.org/pep-0621/), `poetry`, or [`uv`](https://docs.astral.sh/uv/) based `pyproject.toml` file to make and install PyPi package easily (pick `setuptools`, `poetry`, or `uv` when prompted by `copier`)
